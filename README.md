...
*   **Multimodalna Podrška:** *Drag & Drop* sistem omogućava ubacivanje slika, videa i audio fajlova direktno u Prompt.
...
node -v
```
*(Ukoliko Vam komanda nije prepoznata, besplatno preuzmite Node.js sa [nodejs.org](https://nodejs.org/))*
